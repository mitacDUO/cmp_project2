...
double h = 0.001;	//the initail parameter h, the step size
double Y = 0.475;	//Y(e) the number of electrons per nucleon
...
{	
	...
	int i;		//integer controlling the value of parameter rho(c)
	...
	//for loop for multiple values of the parameter rho(c)
	for(i=0;i<11;i++)
	{	
		//how c will vary from 1 to 2
		c=1+0.1*i;
